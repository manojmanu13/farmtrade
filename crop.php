...
<div class="navvbar">
  ...
  <div class="dropdowwn">
    ...
    <div class="dropdowwn-content">
      <a href="prod2.php">manure/seeds</a>
    ...
    <div class="dropdowwn-content">
      ...
      <a href="crop.php">Machine</a>
    </div>
  </div> 
  <a href="ongoing2.html">Ongoing Prices</a>
  <a href="tr2.php">Trader</a>
  
  <a href="logout.php">logout</a>


</div><a href="index2.html">
<img src="images/logo4.png" width="170" height="80" ALIGN="left" clear="left"> </a><center>
</div>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="file" id="image" name="uploadfile" placeholder="Your crop Image..">
    </div>
  </div>
  <br>
  <div class="row">
